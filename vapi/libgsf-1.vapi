...
namespace Gsf {
	...
	public class DocMetaData : GLib.Object {
		...
		public Gsf.DocProp lookup (string name);
		...
		[Version (since = "1.14.24")]
		public bool write_to_odf (void* output);
	}
	...
	public abstract class Infile : Gsf.Input {
		[CCode (has_construct_function = false)]
		protected Infile ();
		public Gsf.Input child_by_aname (string names);
	...
	public class InfileMSVBA : Gsf.Infile {
		...
		public unowned GLib.HashTable<void*,void*> get_modules ();
		public GLib.HashTable<void*,void*> steal_modules ();
	}
	...
	public abstract class Input : GLib.Object {
		public Gsf.gsf_off_t cur_offset;
		[CCode (has_construct_function = false)]
		protected Input ();
		[NoWrapper]
		public virtual uint8 Read (size_t num_bytes, uint8 optional_buffer);
		[NoWrapper]
		public virtual bool Seek (Gsf.gsf_off_t offset, GLib.SeekType whence);
		...
		public bool seek (Gsf.gsf_off_t offset, GLib.SeekType whence);
		public bool seek_emulate (Gsf.gsf_off_t pos);
		...
		public bool set_size (Gsf.gsf_off_t size);
		public Gsf.Input sibling (string name) throws GLib.Error;
		public Gsf.gsf_off_t tell ();
	...
	public class InputMemory : Gsf.Input {
		[CCode (has_construct_function = false, type = "GsfInput*")]
		public InputMemory (uint8 buf, Gsf.gsf_off_t length, bool needs_free);
		[CCode (has_construct_function = false, type = "GsfInput*")]
		public InputMemory.clone (uint8 buf, Gsf.gsf_off_t length);
		[CCode (has_construct_function = false, type = "GsfInput*")]
	...
	public class InputProxy : Gsf.Input {
		...
		[CCode (has_construct_function = false, type = "GsfInput*")]
		public InputProxy.section (Gsf.Input source, Gsf.gsf_off_t offset, Gsf.gsf_off_t size);
	}
	...
	public class InputTextline : Gsf.Input {
		...
		public uint8 ascii_gets ();
		public uint8 utf8_gets ();
	}
	...
	public abstract class Output : GLib.Object {
		...
		public virtual bool Seek (Gsf.gsf_off_t offset, GLib.SeekType whence);
		[NoWrapper]
		public virtual bool Write (size_t num_bytes, uint8 data);
		public bool close ();
		...
		public bool write ([CCode (array_length_cname = "num_bytes", array_length_pos = 0.5, array_length_type = "gsize")] uint8[] data);
		[NoAccessorMethod]
	...
	public class SharedMemory : GLib.Object {
		...
		public Gsf.gsf_off_t size;
		[CCode (has_construct_function = false)]
		public SharedMemory (void* buf, Gsf.gsf_off_t size, bool needs_free);
		[CCode (cname = "gsf_shared_memory_mmapped_new", has_construct_function = false)]
		public SharedMemory.mmapped_new (void* buf, Gsf.gsf_off_t size);
	}
	...
	public struct XMLIn {
		...
		public void push_state (Gsf.XMLInDoc doc, void* new_state, Gsf.XMLInExtDtor dtor, [CCode (type = "xmlChar**")] string attrs);
	...
	public struct XMLInNode {
		...
		public weak global::start start;
		public weak global::end end;
	...
	[CCode (cheader_filename = "gsf/gsf.h", has_target = false)]
	public delegate bool XMLInUnknownFunc (Gsf.XMLIn xin, [CCode (type = "xmlChar*")] string elem, [CCode (type = "xmlChar**")] string attrs);
	[CCode (cheader_filename = "gsf/gsf.h", has_target = false)]
	public delegate bool XMLProbeFunc ([CCode (type = "const xmlChar*")] string name, [CCode (type = "const xmlChar*")] string prefix, [CCode (type = "const xmlChar*")] string URI, int nb_namespaces, [CCode (type = "const xmlChar**")] string namespaces, int nb_attributes, int nb_defaulted, [CCode (type = "const xmlChar**")] string attributes);
	...
	[CCode (cheader_filename = "gsf/gsf.h")]
	public static size_t base64_decode_simple (uint8 data, size_t len);
	[CCode (cheader_filename = "gsf/gsf.h")]
	public static size_t base64_decode_step (uint8 @in, size_t len, uint8 @out, int state, uint save);
	[CCode (cheader_filename = "gsf/gsf.h")]
	public static size_t base64_encode_close (uint8 @in, size_t inlen, bool break_lines, uint8 @out, int state, uint save);
	[CCode (cheader_filename = "gsf/gsf.h")]
	public static uint8 base64_encode_simple (uint8 data, size_t len);
	[CCode (cheader_filename = "gsf/gsf.h")]
	public static size_t base64_encode_step (uint8 @in, size_t len, bool break_lines, uint8 @out, int state, uint save);
	[CCode (cheader_filename = "gsf/gsf.h")]
	...
	[CCode (cheader_filename = "gsf/gsf.h")]
	public static GLib.ByteArray msole_inflate (Gsf.Input input, Gsf.gsf_off_t offset);
	[CCode (cheader_filename = "gsf/gsf.h")]
	...
	[CCode (cheader_filename = "gsf/gsf.h")]
	[Version (since = "1.14.24")]
	public static Gsf.XMLInNS odf_get_ns ();
	[CCode (cheader_filename = "gsf/gsf.h")]
	[Version (since = "1.14.24")]
	public static short odf_get_version ();
	[CCode (cheader_filename = "gsf/gsf.h")]
	[Version (since = "1.14.24")]
	public static string odf_get_version_string ();
	[CCode (cheader_filename = "gsf/gsf.h")]
	...
	[CCode (cheader_filename = "gsf/gsf.h")]
	public static unowned GLib.Parameter? property_settings_find (string name, GLib.Parameter @params, size_t n_params);
	[CCode (cheader_filename = "gsf/gsf.h")]
	public static void property_settings_free (GLib.Parameter @params, size_t n_params);
	[CCode (cheader_filename = "gsf/gsf.h")]
	...
	[CCode (cheader_filename = "gsf/gsf.h")]
	public static uint8 vba_inflate (Gsf.Input input, Gsf.gsf_off_t offset, int size, bool add_null_terminator);
	[CCode (cheader_filename = "gsf/gsf.h")]
